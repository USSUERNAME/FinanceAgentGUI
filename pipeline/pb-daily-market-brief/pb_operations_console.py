...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}body{margin:0;background:radial-gradient(circle at top left,#15294a 0,#08101d 38%);color:var(--text);font:14px/1.55 Inter,Segoe UI,sans-serif}
    ...
    .status{display:inline-flex;border-radius:999px;padding:4px 9px;font-size:12px;font-weight:700}.ready,.success,.verified,.existing_output_attached{background:#123d33;color:var(--green)}.review_required,.skipped_or_notice,.partial,.prepared_for_specialist,.ready_for_review{background:#493d19;color:var(--yellow)}.incomplete,.failed,.unverified,.awaiting_matching_output,.needs_evidence,.needs_korea_market_inputs,.needs_entity_mapping,.no_active_entries{background:#4a202a;color:var(--red)}
